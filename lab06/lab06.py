...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        """
        self.transactions += [Transaction(self.nxt_id, self.balance, self.balance + amount)]
        self.nxt_id += 1
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions += [Transaction(self.nxt_id, self.balance, self.balance)]
            self.nxt_id += 1
...
class Mint:
    ...
    def create(self, coin):
        "*** YOUR CODE HERE ***"
        if coin == Nickel:              # it's a name, not a string
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        if Mint.present_year - 50 > self.year:
